export default function Heritage() {
  return (
    <section className="bg-blue text-cream py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-4xl sm:text-5xl font-serif font-bold mb-6">
              The Heritage of <span className="text-caramel">Blue Pottery</span>
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-cream/70">Each piece is hand-thrown and meticulously hand-painted using traditional techniques passed down through families.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-cream/70">Our master artisans use natural cobalt-based pigments to create the signature deep blue patterns that define our collection.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-cream/70">We remain committed to ethical sourcing and sustainable production methods, ensuring this heritage thrives for generations to come.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 pt-16 border-t border-cream/20">
          <div className="text-center">
            <p className="text-4xl font-bold text-caramel mb-2">500+</p>
            <p className="text-cream/70">Years of Heritage</p>
          </div>
          <div className="text-center">
            <p className="text-4xl font-bold text-caramel mb-2">100%</p>
            <p className="text-cream/70">Handcrafted Pieces</p>
          </div>
          <div className="text-center">
            <p className="text-4xl font-bold text-caramel mb-2">1000+</p>
            <p className="text-cream/70">Artisans Supported</p>
          </div>
        </div>
      </div>
    </section>
